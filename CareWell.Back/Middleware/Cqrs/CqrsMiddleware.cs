...
using CareWell.Common.Extensions;
    ...
    public class CqrsMiddleware
    {
        ...
        public async Task Invoke(HttpContext context)
        {
            ...
            catch (Exception e)
            {
                ...
                else if (e is ServiceCustomException noDataReturned)
                    await ReturnCustomError(context, e, 555);
                else
                    throw;
            }
        }
        ...
        private async Task ReturnCustomError(HttpContext context, Exception e, int statusCode)
        {
            context.Response.StatusCode = statusCode;
            context.Response.ContentType = "application/json";
            var jsonString = JsonSerializer.Serialize(new CommonResponse
